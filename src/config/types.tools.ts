...
export type ToolsConfig = {
  ...
  web?: {
    search?: {
      ...
      searxng?: {
        /** API key for private instances (optional; defaults to SEARXNG_API_KEY env var). */
        apiKey?: string;
        /** Base URL for the SearXNG instance (optional; defaults to SEARXNG_BASE_URL env var). */
        baseUrl?: string;
      };
    };
    fetch?: {
